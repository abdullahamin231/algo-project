...
def demo_small_example():
    """
    Reproduce the small example similar to the assignment description:
    Insert:
    ...
    most_pop_bst = bst.getMostPopular()
    print("Most popular in BST:", most_pop_bst)
    print("Most recent 3 in BST:", bst.getMostRecent(3))
    print("BST height:", bst.height(), "balance factor:", bst.balancing_factor())
    ...
    most_pop_treap = treap.getMostPopular()
    print("Most popular in Treap:", most_pop_treap)
    print("Most recent 3 in Treap:", treap.getMostRecent(3))
    print("Treap height:", treap.height(), "balance factor:", treap.balancing_factor())
